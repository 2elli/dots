# Generated by Powerlevel10k configuration wizard on 2025-10-05 at 17:55 CDT.
...
# solid, no frame, black-ornaments, compact, few icons, concise, transient_prompt,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean="%${magenta}F" # green foreground
